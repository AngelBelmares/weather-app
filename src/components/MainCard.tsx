...
export function MainCard ({ currentConditions }: MainCardProps): JSX.Element {
  ...
  return (
    <article className='flex flex-col items-center text-center w-1/2 justify-center text-xl text-white  p-4 m-4 bg-white/20 rounded-sm shadow-lg backdrop-blur-sm'>
