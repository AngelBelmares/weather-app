...
export function MainCard ({ currentConditions, tzoffset }: MainCardProps): JSX.Element {
  ...
  return (
    <article className='flex flex-col items-center text-center w-1/2 justify-center text-xl text-white p-4 bg-white/45 dark:bg-black/15 rounded-sm shadow-lg backdrop-blur-sm '>
