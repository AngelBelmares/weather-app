...
export function WeatherCard ({ day, imageSrc, temperature, conditions }: WeatherCardProps): JSX.Element {
  ...
  return (
    <article className='flex flex-col text-white justify-center items-center min-h-32 min-w-40 p-2 rounded-sm cursor-pointer backdrop-blur-sm bg-white/20 shadow-md hover:brightness-110'>
